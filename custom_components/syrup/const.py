"""Konstanten fuer die SYRUP-Integration."""
...
DEFAULT_POLL_INTERVAL = 10  # Sekunden, wird dem Geraet als <ct rt="..."/> mitgeteilt
...
# SafeTech Connect und ist fuer das Safe-T+ noch nicht gegengeprueft.
AB_OPEN = "1"
AB_CLOSED = "2"
